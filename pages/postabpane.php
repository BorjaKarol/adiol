...
<div class="tab-content">
    <!-- 1ST TAB -->
    <div class="tab-pane fade in mt-2" id="beef">
        <div class="row">
    ...
    <?php
                                    ...
                                    ?>
    <!-- 2ND TAB -->
    <div class="tab-pane fade in mt-2" id="chicken">
        <div class="row">
    ...
    <!-- 3rd TAB -->
    <div class="tab-pane fade in mt-2" id="seafood">
        <div class="row">
    ...
    <!-- 4th TAB -->
    <div class="tab-pane fade in mt-2" id="pork">
        <div class="row">
    ...
    <!-- 5th TAB -->
    <div class="tab-pane fade in mt-2" id="processedmeat">
        <div class="row">
